...
namespace Crawler.Tests.SpellCheck
{
	...
	public class ScriptUrlKeyTests
	{
		...
		public void NonStandardFingerprintLeftIntact_NeverWrongJoined()
		{
			...
			const string url = "https://h/x/vendoragentjs_ABCDEFGHIJKL_10331260218130851.js";
			Assert.Equal("/x/vendoragentjs_ABCDEFGHIJKL_10331260218130851.js", ScriptUrlKey.StableKey(url));
		}
