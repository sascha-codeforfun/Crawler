	...
	public class TicketHeadlineTests
	{
		...
		public void ShortenPath_NoMatches_ReturnsOriginal()
		{
			var result = TicketRenderer.ShortenPath(
				"/de/home/page.html",
				new List<string> { "privatkunden", "pensions" });
		...
		public void ShortenPath_ConsecutiveMatches_StayAsSeparateDots()
		{
			...
			var result = TicketRenderer.ShortenPath(
				"/de/home/privatkunden/pensions/page.html",
				new List<string> { "privatkunden", "pensions" });
			Assert.Equal("/de/home/.../.../page.html", result);
		}
		...
		public void ShortenPath_RealWorldExample_ShortensAsDesigned()
		{
			...
			var result = TicketRenderer.ShortenPath(
				"/de/home/privatkunden/pensions/annuity-xyz/lightboxes/maximale-flexibiilitaet.html",
				new List<string> { "privatkunden", "pensions" });
			Assert.Equal(
				"/de/home/.../.../annuity-xyz/lightboxes/maximale-flexibiilitaet.html",
				result);
		}
		...
		{
			var cfg = HeadlineConfig(
				shortenSegments: new List<string> { "privatkunden", "pensions" });
			var result = Headline(cfg, "https://www.example.com/de/home/privatkunden/pensions/page.html");
			Assert.Equal("WEBSITE - SPELLING - /de/home/.../.../page.html", result);
		}
