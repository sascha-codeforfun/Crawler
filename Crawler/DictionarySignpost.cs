namespace Crawler
{
	...
	/// <see cref="DictionaryIntegrity"/> owns the configured-but-broken cases
	...
	/// </summary>
	internal static class DictionarySignpost
	{
		...
		/// or more bundles are configured, do nothing (DictionaryIntegrity owns it).
		/// </summary>
		public static void EmitIfUnconfigured(Config config)
		{
			try
			{
				// Operator has configured bundles -> DictionaryIntegrity owns it; stay silent.
